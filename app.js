...
function updateOnboardingStep() {
  ...
  switch (onboardingStep) {
    ...
    case 3:
      setOnboardingPortraitState("purple");
      dialogueText.innerHTML = `<strong>STEP 2: DATABASE ANCHOR.</strong><br><br>I sync your telemetry to a Google Sheet so it survives your inevitable memory collapses. To set up the Sheet database script:<br><br>1. Open your Google Sheet, go to <strong>Extensions -> Apps Script</strong>.<br>2. Open this link: <a href="https://raw.githubusercontent.com/DarthRyan-explore/nutrition-hud/main/google_apps_script.js" target="_blank" class="hyperlink-tech">Google Apps Script Code</a>. Copy every single line of code on that page.<br>3. Delete any existing code in the Apps Script editor, paste this copied code, and click Save.<br>4. Click <strong>Deploy</strong> (top right) -> <strong>New deployment</strong>.<br>5. Choose Type: <strong>Web App</strong>, execute as: <strong>Me</strong>, and access: <strong>Anyone</strong>.<br>6. Click Deploy, authorize permissions, and copy the <strong>Web App URL</strong> (ends in <code>/exec</code>).<br><br>⚠️ <strong>DO NOT copy the Google Sheet page link or ID! Only paste the deployed Web App URL below:</strong>`;
