...
function updateOnboardingStep() {
  ...
  switch (onboardingStep) {
    ...
    case 3:
      setOnboardingPortraitState("purple");
      dialogueText.innerText = "STEP 2: DATABASE ANCHOR.\n\nI SYNC YOUR TELEMETRY TO A GOOGLE SHEET SO IT SURVIVES YOUR INEVITABLE MEMORY COLLAPSES. TO SET UP THE SCRIPT DOCK:\n\n1. OPEN YOUR GOOGLE SHEET, GO TO EXTENSIONS -> APPS SCRIPT.\n2. IN YOUR LOCAL COMPUTER FOLDER, OPEN THE FILE NAMED 'google_apps_script.js'. COPY EVERY SINGLE LINE OF CODE IN THAT FILE.\n3. IN THE APPS SCRIPT WEB PAGE, DELETE ANY EXISTING CODE, PASTE THIS COPIED CODE, AND SAVE.\n4. CLICK 'DEPLOY' (TOP RIGHT) -> 'NEW DEPLOYMENT'.\n5. CHOOSE TYPE: 'WEB APP', SET EXECUTE AS: 'ME', AND ACCESS: 'ANYONE'.\n6. CLICK DEPLOY, AUTHORIZE ACCESS, AND COPY THE 'WEB APP URL' (ENDS IN '/exec').\n\n⚠️ DO NOT COPY THE GOOGLE SHEET PAGE LINK OR ID! ONLY PASTE THE DEPLOYED WEB APP URL BELOW:";
